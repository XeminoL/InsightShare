...
Kỳ thực tập tại **Công ty TNHH Amazon Web Services Việt Nam** diễn ra từ **01/06/2026** đến **15/08/2026**.

Sản phẩm chính là **InsightShare**, ứng dụng web upload và chia sẻ ảnh/tài liệu theo hướng serverless trên AWS. Công việc trải qua S3, Lambda, API Gateway, DynamoDB, Cognito, CloudFront, IAM, CloudWatch, các dịch vụ AI Rekognition, Textract và Bedrock, Python, cùng tài liệu kỹ thuật song ngữ.
...
| 2 | **Khả năng học hỏi** | x | | Tự học các dịch vụ mới qua tài liệu và lab. |
...
| 7 | **Tư duy giải quyết vấn đề** | x | | Chẩn đoán các lỗi tích hợp từ log CloudWatch. |
| 8 | **Đóng góp cho dự án** | x | | Tự làm InsightShare end-to-end và bổ sung tính năng thêm. |
...
* Các lệnh gọi AI nên bọc lại và có đường lùi, để một dịch vụ không sẵn sàng chỉ làm mất phần phân tích chứ luồng upload vẫn xong.
