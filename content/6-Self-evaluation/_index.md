...
The internship at **Amazon Web Services Vietnam Co., Ltd.** runs from **June 1, 2026** to **August 15, 2026**.

The main deliverable is **InsightShare**, a serverless web application for uploading and sharing images and documents on AWS. The work involved S3, Lambda, API Gateway, DynamoDB, Cognito, CloudFront, IAM and CloudWatch, the AI services Rekognition, Textract and Bedrock, Python, and bilingual technical documentation.
...
| 2 | **Ability to learn** | x | | Picked up new services from docs and labs. |
...
| 7 | **Problem-solving** | x | | Diagnosed integration issues from CloudWatch logs. |
| 8 | **Contribution to the project** | x | | Implemented InsightShare end-to-end and added extra features. |
...
* AI calls should fail soft and stay wrapped, so one unavailable service degrades gracefully instead of breaking the whole upload and analysis flow.
