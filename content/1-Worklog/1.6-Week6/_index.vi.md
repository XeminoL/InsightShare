...
| --- | --- | --- | --- | --- |
| 2 | Tạo HTTP API Gateway tích hợp Lambda proxy, định nghĩa route cho từng endpoint. | 06/07/2026 | 06/07/2026 | [API Gateway lab](https://000079.awsstudygroup.com) |
| 3 | Cấu hình CORS ở tầng API Gateway và thêm quyền cho gateway gọi Lambda. | 07/07/2026 | 07/07/2026 | |
