...
| --- | --- | --- | --- | --- |
| Mon | Create an on-demand DynamoDB table with `id` as the partition key; design the item around the access patterns. | 13/07/2026 | 13/07/2026 | [Serverless lab](https://000078.awsstudygroup.com) |
