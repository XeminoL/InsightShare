...
| 6 | Tối ưu chi phí và rà soát least-privilege toàn hệ thống. | 07/08/2026 | 07/08/2026 | |

### Kết quả đạt được

1. Tìm được file theo nội dung, và endpoint `/ask` trả lời trên toàn thư viện có trích nguồn file.
2. Frontend chạy trên S3 + CloudFront qua HTTPS; bucket file vẫn private và chỉ vào được qua presigned URL.
