...
| Wed | Write the Proposal: problem, solution, the AWS services table (11 services) and the rationale for each, all in region ap-southeast-1. | 10/06/2026 | 10/06/2026 |  |
...
| Fri | Design the DynamoDB metadata table (partition key `id`, attributes for owner, timestamp, AI labels and extracted text); study presigned URLs and the AI APIs detect_labels, detect_document_text and Bedrock invoke_model. | 12/06/2026 | 12/06/2026 | [AI services](https://000056.awsstudygroup.com) |
