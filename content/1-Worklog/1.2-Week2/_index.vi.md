...
| 3 | Vẽ sơ đồ kiến trúc serverless của InsightShare bằng draw.io: trình duyệt → CloudFront/S3 → API Gateway → Lambda → S3/DynamoDB và nhánh Rekognition/Textract/Bedrock. | 09/06/2026 | 09/06/2026 | [draw.io](https://draw.io/) |
| 4 | Viết Proposal: vấn đề, giải pháp, bảng dịch vụ AWS (11 dịch vụ) và lý do chọn từng dịch vụ, đều ở region ap-southeast-1. | 10/06/2026 | 10/06/2026 |  |
...
| 6 | Thiết kế bảng DynamoDB cho metadata (partition key `id`, các thuộc tính owner, thời gian, nhãn AI và text trích); tìm hiểu presigned URL và các API AI detect_labels, detect_document_text, Bedrock invoke_model. | 12/06/2026 | 12/06/2026 | [AI services](https://000056.awsstudygroup.com) |
