...
| 5 | Thêm endpoint `POST /files/{id}/ask`: gửi văn bản đã trích kèm câu hỏi tới một model Claude trên Amazon Bedrock (`invoke_model`) và trả về câu trả lời theo ngôn ngữ câu hỏi; không có câu hỏi thì tóm tắt. | 23/07/2026 | 23/07/2026 | [Bedrock](https://docs.aws.amazon.com/bedrock/) |
