...
| --- | --- | --- | --- | --- |
| 2 | Thêm tính năng xóa file (xóa object S3 và item DynamoDB cùng lúc), đặt hạn cho link chia sẻ và kiểm tra dung lượng/loại file trước khi upload. | 10/08/2026 | 10/08/2026 |  |
...
| 5 | Tìm hiểu Step Functions và cách dùng state machine điều phối pipeline nhiều bước Rekognition → Textract → Polly. | 13/08/2026 | 13/08/2026 | [Modernize](https://cloudjourney.awsstudygroup.com/4-modernize/) |
...
1. Bổ sung các tính năng nâng cao (xóa file, link có hạn, giới hạn upload) làm phần đóng góp riêng.
