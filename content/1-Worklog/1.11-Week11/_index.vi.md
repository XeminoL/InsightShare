...
| --- | --- | --- | --- | --- |
| 2 | Viết script deploy để deploy lại sau khi đổi code chỉ bằng một lệnh. | 10/08/2026 | 10/08/2026 | |
...
| 5 | Viết script dọn dẹp xóa toàn bộ stack; ghi chú Step Functions như cách điều phối pipeline AI nhiều bước về sau. | 13/08/2026 | 13/08/2026 | [Modernize](https://cloudjourney.awsstudygroup.com/4-modernize/) |
| 6 | Quay video demo và hoàn thiện báo cáo song ngữ. | 14/08/2026 | 14/08/2026 | |

### Kết quả đạt được

1. Deploy và dọn dẹp đã được script hóa, nên deploy lại chỉ còn một lệnh, còn dọn tài nguyên chỉ để lại CloudFront distribution phải disable bằng tay.
