...
| Fri | Put the infrastructure in code with AWS SAM (template.yaml) so the stack can be deployed or torn down in one command. | 31/07/2026 | 31/07/2026 | [AWS SAM](https://000080.awsstudygroup.com) |
...
3. Reduced cost, tightened security, and managed all infrastructure with SAM.
