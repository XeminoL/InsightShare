...
| Fri | Optimize cost and write a repeatable cleanup script (cleanup-aws.ps1) that tears the whole stack down in one run. | 31/07/2026 | 31/07/2026 |  |
...
3. Reduced cost, tightened security, and scripted teardown of every resource in one command.
