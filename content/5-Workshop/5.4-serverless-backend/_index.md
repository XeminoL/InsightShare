...
+ **Lambda** handles the business logic: receive requests, generate presigned URLs, write metadata.
...
+ **DynamoDB** stores the metadata of each file.
+ The **AI layer** labels images, extracts document text, and answers questions about a document.
+ The **frontend** is hosted on **S3 + CloudFront**.
...
- [Add AI: Rekognition, Textract, Bedrock](5.4.6-ai-services/)