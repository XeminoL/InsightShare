...
Search returned the image from the label `Diagram`. On a `.txt` document, `ask` returned an answer taken from the document text, generated by Amazon Bedrock (Claude).
