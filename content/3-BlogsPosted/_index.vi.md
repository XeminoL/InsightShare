...
Giới thiệu tính năng Lambda Durable Functions xây các luồng xử lý dài hạn ngay trong Lambda, với việc lưu trạng thái và phục hồi lỗi do runtime lo.

### [Blog 3 - AWS Lambda MicroVMs: sandbox cách ly, giữ trạng thái để chạy code không tin cậy](3.3-Blog3/)
Giới thiệu AWS Lambda MicroVMs, một compute primitive serverless chạy code do người dùng gửi lên hoặc do AI sinh ra, với mức cách ly ngang máy ảo, khởi động gần như tức thì từ snapshot và giữ trạng thái.