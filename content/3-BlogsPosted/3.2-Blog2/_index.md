...
### The problem
Building a long-running flow forced developers to write a lot of code to store state, handle errors and wire services together, laborious and error-prone.
...
It also has built-in idempotency and integrates with EventBridge to emit execution state.
